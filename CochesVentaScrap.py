    ...
    for j in range (1,20):
        ...
        if status_code == 200:
            ...
            for i in range(len(precios)):  
                ...
                #Guardamos los datos si la version no esta informada n/a
                if (len(filas))==2:
                   ver=t2[i].find_all('h2')[1].text #versión
                   DatosCoches=[fecha,mod,ver,precio,km,Anyo,KWCV,Automatico,Elec]
                else:
                   DatosCoches=[fecha,mod,"n/a",precio,km,Anyo,KWCV,Automatico,Elec]
...
ListaCoches=[]
Cabecera=["Fecha","Modelo","Versión","Precio","Kilometraje","Año","Motor","Tipo"]
