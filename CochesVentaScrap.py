...
# Filtros permanentes aplicados (Busquedas restinguidas a España, de vehículos de ocasión, de Particulares)
# España: cy=E, Vehículo de Ocasión: offer=U, tamaño anuncios: size=20, custtype=Particular

# Filtros opcionales pasados como parámetros:
# /MARCA/MODELO/, fregto=DESDE AÑO, fregfrom=HASTA AÑO, version0=VERSION

# Generamos url personalizada
...
def encontrarCoches(url):
    ...
    #Máximo 10 páginas (unos 200 vehículos)

    MAX_PAG = 10

    #paginacion
    for j in range (1,MAX_PAG):
        ...
        if status_code == 200:
            ...
            for i in range(len(precios)):  
                ...
                #Guardamos los datos, si la version no esta informada, n/a. Se añade Fecha
                if (len(filas))==2:
